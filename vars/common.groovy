...
{   
    sh '''
             ...
             sonar-scanner -Dsonar.sources=. sonar.java.binaries=target/ -Dsonar.login=0137a6f92286deae048a73f8f632c18530ae98ca -Dsonar.host.url=http://54.90.171.239:9000 -Dsonar.projectKey=${COMPONENT}
