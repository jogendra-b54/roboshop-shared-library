...
{   
    sh '''
             ...
             sonar-scanner -Dsonar.login="${SONARCRED_USR}" -Dsonar.password=${SONARCRED_PSW} -Dsonar.host.url=http://3.87.235.39:9000 -Dsonar.projectKey=${COMPONENT} ${ARGS}
...
//          sh  'sonar-scanner -Dsonar.host.url=http://3.87.235.39:9000  ${ARGS} -Dsonar.projectKey=${COMPONENT} -Dsonar.login=admin  -Dsonar.password=password'
